...
final class Draughts10x10 extends JFrame {
    ...
    //AI (1-5)
    final static JSlider AI = new JSlider(MIN_LEVEL, MAX_LEVEL);//4
    ...
    private Draughts10x10(int boardSize) {
        ...
        AI.setMajorTickSpacing(1);//1-5
        AI.setPaintTicks(true);//no labels/digits -> no extra distraction -> see tooltiptext
        AI.setOpaque(false);
