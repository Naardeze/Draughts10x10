...
final class Draughts10x10 extends JFrame {
    ...
    //static components
    final static JButton UNDO = new JButton(new ImageIcon(Toolkit.getDefaultToolkit().createImage("arrow.png")));//undo move
