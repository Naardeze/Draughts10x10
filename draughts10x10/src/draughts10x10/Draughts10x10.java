 ...
 * AI (1-7) -> search depth (moves + AI + depth=0 while captures>0)
 * 
...
final class Draughts10x10 extends JFrame {
    ...
    private Draughts10x10(int boardSize) {
        ...
        //game on/off BOARD10X10
        BOARD10X10.addContainerListener(new ContainerAdapter() {
            @Override
        ...
        rotation.setToolTipText("Rotate Board");
