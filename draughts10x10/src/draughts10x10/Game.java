 ...
 * 
 * -turn (moves -> evaluation (game_over || move (player(hintBoard) || ai(MinMax))))
            ...
            if (moves.isEmpty()) {//game over
                ...
                new Thread(){
                    ...
                    public void run() {
                        ...
                        new BoardMove(color, MinMax.getAIMove(color, position, pieces, moves, maxCapture, AI.getValue())).run();
                    }
                }.start();
            }
