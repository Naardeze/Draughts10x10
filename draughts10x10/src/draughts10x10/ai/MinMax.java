 ...
 * MinMax
 * 
 * Minimax with alfa beta pruning, extends HashMap (position, value) -> prevent re)calculations
 * 
...
public class MinMax extends HashMap<String, Integer> {
    ...
    private int valueOf(char[] position, long turn, long opponent, MinMax minMax, int value, int[] alfaBeta, int depth) {
