...
final class MinMax extends HashMap<String, Integer> {//<position, move value>    
    private static enum Node {
        MIN {//player
            ...
            @Override
            int valueOf(long turn, long opponent) {
                return Long.bitCount(opponent) - Long.bitCount(turn);
            }
        },
        MAX {//ai
            @Override
            ...
            @Override
            int valueOf(long turn, long opponent) {
                return Long.bitCount(turn) - Long.bitCount(opponent);
            }
        };

        abstract boolean isAlfaBeta(int alfaBeta, int value);
        abstract int valueOf(long turn, long opponent);
    }
    ...
    private int valueOf(char[] position, long turn, long opponent, MinMax minMax, int[] alfaBeta, int depth) {
        ...
        pruning : {
            ...
            //return move value
                ...
                return node.valueOf(turn, opponent);
            }
