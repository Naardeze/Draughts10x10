 ...
 * 
 * Special Thanx to Logic Crrazy Chess
 * 
 * @author Naardez
 */
...
class MinMax extends HashMap<String, Integer> {
                        ...
                        if ((capture & middle) != 0l) {
                            ...
                            if ((step & empty) == step) {
                                ...
                                do {
                                    ...
                                    //empty square(s) after last capture
    ...
    static LinkedList<Integer> getAIMove(int ai, char[] position, HashSet<Integer>[] pieces, HashMap<Integer, LinkedList<Integer>[]> moves, int depth) {
        //opponent
        int player = 1 - ai;
        ...
        for (int from : moves.keySet()) {
            ...
            for (LinkedList<Integer> move : moves.get(from)) {
                ...
                //beta
                int min = new MinMax(Node.MIN, player).valueOf(getPosition(ai, position.clone(), piece, move, to), opponent ^ capture, turn ^ (1l << from ^ 1l << to), new MinMax(Node.MAX, ai), new int[] {ALFA, BETA}, depth);
