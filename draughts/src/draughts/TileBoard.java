    ...
    TileBoard() {
        ...
        addComponentListener(new ComponentAdapter() {
            ...
            public void componentResized(ComponentEvent e) {//once at start program
                ...
                for (char piece : WB.toCharArray()) {//scale PIECE (tile size)
                    PIECE[0][WB.indexOf(piece)] = Toolkit.getDefaultToolkit().createImage(piece + ".png").getScaledInstance(width, height, new int[]{Image.SCALE_SMOOTH,Image.SCALE_AREA_AVERAGING}[WB.indexOf(piece)]);//pawm
